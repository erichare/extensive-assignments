...
alpha <- 1.026
par.zigp.newtraph <- newton.raphson(zigp.loglik, zigp.gradient, zigp.hessian, start = par.zip.newtraph.full, y = bean.data$mvm, x = bean.data$price, alpha = alpha, max.iterations=0)
@
