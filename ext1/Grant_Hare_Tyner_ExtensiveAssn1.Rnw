...
\ell_{1}(\lambda_i, \pi_i) &= log((1 - \pi_i) + \pi_i e^{-\lambda_i})I(y_{i} = 0) \\
&= log(1 + \pi_i(e^{-\lambda_i} - 1))I(y_{i} = 0) \\
\ell_{2}(\lambda_i, \pi_i) &= \bigg[log \pi_i - \lambda_i + \sum_{i = 1}^{n} y_{i} log \lambda_i + \sum_{i = 1}^{n} \frac{1}{y_{i}!}\bigg]I(y_{i} > 0) \\
\ell(\lambda_i, \pi_i) &= \ell_{1}(\lambda_i, \pi_i) + \ell_{2}(\lambda_i, \pi_i)
\end{align*}
Now, assume $\pi_i = \frac{e^{\beta_{0} + \beta_{1}x_{i}}}{1 + e^{\beta_{0} + \beta_{1}x_{i}}}$ and $\lambda_i = e^{\delta_{0} + \delta_{1}x_{i}}$.  Then, 
\begin{align*}
\ell_{1}(\lambda_i, \pi_i) &= log\bigg[1 - \frac{e^{\beta_{0} + \beta_{1}x_{i}}}{1 + e^{\beta_{0} + \beta_{1}x_{i}}}(exp\{-e^{\delta_{0} + \delta_{1}x_{i}}\} - 1)\bigg] \\
\ell_{2}(\lambda_i, \pi_i) &= log\bigg(\frac{e^{\beta_{0} + \beta_{1}x_{i}}}{1 + e^{\beta_{0} + \beta_{1}x_{i}}}\bigg) - e^{\delta_{0} + \delta_{1}x_{i}} + \sum_{i = 1}^{n} y_{i} log(e^{\delta_{0} + \delta_{1}x_{i}}) + \sum_{i = 1}^{n} \frac{1}{y_{i}!}\\
\ell(\lambda_i, \pi_i) &= \ell_{1}(\lambda_i, \pi_i) + \ell_{2}(\lambda_i, \pi_i)
\end{align*}
