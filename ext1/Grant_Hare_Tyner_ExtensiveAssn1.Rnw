...
print(xtable(sip.table, digits = c(0, 0, 4, 4), caption = "MLEs for the first nine stores", label = "tbl:sip.table"), table.position = 'H', include.rownames = FALSE)
@
...
print(xtable(my.df, digits = c(0, 0, rep(4, 4)), caption = "Comparison of MLEs to results obtained from glm package", label = "tbl:sip.compare"), table.position = 'H', include.rownames = FALSE)
@
...
print(xtable(zip.table, digits = c(0, 0, 4, 4, 4, 4), caption = "MLEs for the first nine stores", label = "tbl:zip.table"), table.position = 'H')
@
...
print(xtable(zigp.table, digits = c(0, 4, 4, 4, 4, 4), caption = "MLEs for the model for all stores", label = "tbl:zigp.table"), table.position = 'H')
@
...
print(xtable(my.df, digits = c(0, rep(4, 8)), caption = "Comparison of MLEs to results obtained from pscl package", label = "tbl:zigp.compare"), table.position = 'H')
@
...
print(xtable(bayes_ests, digits = c(0, 0, rep(4,8)), caption = "Posterior Means and Medians of the Parameters for the first 9 stores", label = "tbl:Bayes.ests"), table.position = 'H',, include.rownames = FALSE)
@
